...
public class FutuBase implements FTSPI_Conn, FTSPI_Qot, FTSPI_Trd {
    ...
    protected QotRequestHistoryKL.Response getHistoryKL(QotRequestHistoryKL.C2S c2s) throws InterruptedException {
        ReqInfo reqInfo = null;
    ...
    protected QotGetOrderBook.Response getOrderBookSync(QotCommon.Security sec, int num) throws InterruptedException {
        ReqInfo reqInfo = null;
        Object syncEvent = new Object();
    ...
    public TrdPlaceOrder.Response placeOrderSync(TrdPlaceOrder.C2S c2s) throws InterruptedException {
        ReqInfo reqInfo = null;
        Object syncEvent = new Object();
    ...
    protected TrdGetOrderList.Response getOrderListSync(long accID, TrdCommon.TrdMarket trdMarket, TrdCommon.TrdEnv trdEnv,
                                                        boolean isRefreshCache,
    ...
    public TrdGetOrderFillList.Response getOrderFillListSync(long accID, TrdCommon.TrdMarket trdMarket, TrdCommon.TrdEnv trdEnv,
                                                             boolean isRefreshCache,
    ...
    protected TrdGetPositionList.Response getPositionListSync(long accID, TrdCommon.TrdMarket trdMarket, TrdCommon.TrdEnv trdEnv,
                                                              TrdCommon.TrdFilterConditions filterConditions,
