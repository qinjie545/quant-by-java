...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new SecurityKLineFacade().query(QotCommon.QotMarket.QotMarket_CNSH_Security, "601818", "2022-09-01", "2022-09-10"  );
...
//        switch (nDemoIndex) {
//            case 0: {
//                GetSecuritySnapshotFutu demo = new GetSecuritySnapshotFutu();
//                demo.run(QotCommon.QotMarket.QotMarket_HK_Security);
//                break;
//            }
//            case 1: {
//                MACDStrategyFutu demo = new MACDStrategyFutu();
...
//            }
//            case 2: {
//                QuoteAndTradeFutu demo = new QuoteAndTradeFutu();
//                demo.quoteTest();
//                break;
//            }
//            case 3: {
//                StockSellFutu demo = new StockSellFutu();
